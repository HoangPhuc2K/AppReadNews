...
public class ListNewsAdapter extends RecyclerView.Adapter<ListNewsAdapter.NewHotViewHolder> {
    private final LinkedList<News> mListNewsHot;
    private LayoutInflater mInflater;
    private Context context;
    private String Url = "http://10.0.2.2:8000/storage/";

    public ListNewsAdapter(Context context, LinkedList<News> mListNewsHot) {
    ...
    @NonNull
    @Override
    public ListNewsAdapter.NewHotViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mItemView = mInflater.inflate(R.layout.layout_item_news,parent,false);
        return new ListNewsAdapter.NewHotViewHolder(mItemView,this);
    }

    @Override
    public void onBindViewHolder(@NonNull ListNewsAdapter.NewHotViewHolder holder, int position) {
    ...
    public class NewHotViewHolder extends RecyclerView.ViewHolder{
        ...
        public NewHotViewHolder(@NonNull View itemView, ListNewsAdapter adapter) {
            super(itemView);
