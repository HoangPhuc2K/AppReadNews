...
public class ListVideoAdapter extends RecyclerView.Adapter<ListVideoAdapter.NewHotViewHolder> {
    private final LinkedList<News> mListNews;
    private LayoutInflater mInflater;
    private Context context;

    public ListVideoAdapter(Context context, LinkedList<News> mListNewsHot) {
    ...
    @NonNull
    @Override
    public ListVideoAdapter.NewHotViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mItemView = mInflater.inflate(R.layout.layout_item_news,parent,false);
        return new ListVideoAdapter.NewHotViewHolder(mItemView,this);
    }
    ...
    public class NewHotViewHolder extends RecyclerView.ViewHolder{
        final ListVideoAdapter Adapter;
        ...
        public NewHotViewHolder(@NonNull View itemView, ListVideoAdapter adapter) {
            super(itemView);
