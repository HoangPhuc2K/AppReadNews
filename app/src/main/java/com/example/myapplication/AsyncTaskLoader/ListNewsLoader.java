...
public class ListNewsLoader extends AsyncTaskLoader<LinkedList<News>>  {

    public ListNewsLoader(@NonNull Context context) {
        super(context);
    }
    @Nullable
    @Override
    public LinkedList<News> loadInBackground() {
        ...
        try {
            JSONObject jsonObject = new JSONObject(NetworkUtils.loadListNews());
            JSONArray jsonArray = jsonObject.getJSONArray("data");
            Log.d("loadnews",jsonObject.toString());
