...
public class ListNewsSportLoader extends AsyncTaskLoader<LinkedList<News>> {

    public ListNewsSportLoader(@NonNull Context context) {
        super(context);
    }
    ...
    public LinkedList<News> loadInBackground() {
        ...
        try {
            JSONObject jsonObject = new JSONObject(NetworkUtils.loadListNewsSport());
